...
public class ItemHelper {
   ...
   public static final Item[] IRON_ARMORS = new Item[] { Items.IRON_CHESTPLATE, Items.IRON_LEGGINGS, Items.IRON_HELMET,
         Items.IRON_BOOTS };
   ...
   public static final Item[] WOODEN_TOOLS = new Item[] { Items.WOODEN_PICKAXE, Items.WOODEN_SHOVEL, Items.WOODEN_SWORD,
   ...
   public static final Item[] GOLDEN_TOOLS = new Item[] { Items.GOLDEN_PICKAXE, Items.GOLDEN_SHOVEL, Items.GOLDEN_SWORD,
   ...
   public static boolean canThrowAwayStack(PlayerEngineController mod, ItemStack stack) {
      if (stack.isEmpty()) {
         ...
         return isStackProtected(mod, stack) ? false
               : mod.getModSettings().isThrowaway(stack.getItem()) || mod.getModSettings().shouldThrowawayUnusedItems();
      }
   }
