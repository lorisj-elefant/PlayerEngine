...
public class MovementAscend extends Movement {
    ...
    public MovementAscend(IBaritone baritone, BetterBlockPos src, BetterBlockPos dest) {
        super(baritone, src, dest, buildPositionsToBreak(baritone.getEntityContext().entity(), src, dest), buildPositionsToPlace(baritone.getEntityContext().entity(), src, dest));
    }
