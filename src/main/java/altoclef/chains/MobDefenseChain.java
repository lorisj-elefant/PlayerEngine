...
import altoclef.control.KillAura;
import altoclef.multiversion.item.ItemVer;
import altoclef.tasks.construction.ProjectileProtectionWallTask;
import altoclef.tasks.entity.KillEntitiesTask;
import altoclef.tasks.movement.CustomBaritoneGoalTask;
import altoclef.tasks.movement.DodgeProjectilesTask;
import altoclef.tasks.movement.RunAwayFromCreepersTask;
...
import altoclef.util.baritone.CachedProjectile;
import altoclef.util.helpers.BaritoneHelper;
import altoclef.util.helpers.EntityHelper;
