...
import altoclef.tasks.resources.CarveThenCollectTask;
import altoclef.tasks.resources.CollectAmethystBlockTask;
import altoclef.tasks.resources.CollectBedTask;
import altoclef.tasks.resources.CollectBlazeRodsTask;
import altoclef.tasks.resources.CollectBlockByOneTask;
import altoclef.tasks.resources.CollectBucketLiquidTask;
import altoclef.tasks.resources.CollectCoarseDirtTask;
import altoclef.tasks.resources.CollectCocoaBeansTask;
import altoclef.tasks.resources.CollectCropTask;
import altoclef.tasks.resources.CollectDripstoneBlockTask;
import altoclef.tasks.resources.CollectEggsTask;
import altoclef.tasks.resources.CollectFlintTask;
import altoclef.tasks.resources.CollectFlowerTask;
import altoclef.tasks.resources.CollectGoldIngotTask;
import altoclef.tasks.resources.CollectGoldNuggetsTask;
import altoclef.tasks.resources.CollectHayBlockTask;
import altoclef.tasks.resources.CollectHoneycombTask;
import altoclef.tasks.resources.CollectIronIngotTask;
import altoclef.tasks.resources.CollectMagmaCreamTask;
import altoclef.tasks.resources.CollectMilkTask;
import altoclef.tasks.resources.CollectNetherBricksTask;
import altoclef.tasks.resources.CollectObsidianTask;
import altoclef.tasks.resources.CollectPlanksTask;
import altoclef.tasks.resources.CollectRedSandstoneTask;
import altoclef.tasks.resources.CollectSandstoneTask;
import altoclef.tasks.resources.CollectSaplingsTask;
import altoclef.tasks.resources.CollectSticksTask;
import altoclef.tasks.resources.CollectStrippedLogTask;
import altoclef.tasks.resources.CollectWheatSeedsTask;
import altoclef.tasks.resources.CollectWheatTask;
import altoclef.tasks.resources.CollectWoolTask;
import altoclef.tasks.resources.GetSmithingTemplateTask;
import altoclef.tasks.resources.KillAndLootTask;
import altoclef.tasks.resources.KillEndermanTask;
import altoclef.tasks.resources.MineAndCollectTask;
import altoclef.tasks.resources.ShearAndCollectBlockTask;
import altoclef.tasks.resources.wood.CollectBoatTask;
import altoclef.tasks.resources.wood.CollectFenceGateTask;
import altoclef.tasks.resources.wood.CollectFenceTask;
import altoclef.tasks.resources.wood.CollectHangingSignTask;
import altoclef.tasks.resources.wood.CollectSignTask;
import altoclef.tasks.resources.wood.CollectWoodenButtonTask;
import altoclef.tasks.resources.wood.CollectWoodenDoorTask;
import altoclef.tasks.resources.wood.CollectWoodenPressurePlateTask;
import altoclef.tasks.resources.wood.CollectWoodenSlabTask;
import altoclef.tasks.resources.wood.CollectWoodenStairsTask;
import altoclef.tasks.resources.wood.CollectWoodenTrapDoorTask;
