...
public class UseItemOnEntity extends Task {
    String itemName;
    String entityName;
    ...
    public UseItemOnEntity(String itemName, String entityName) {
    ...
    protected boolean isEqual(Task var1) {
        ...
        if (!(var1 instanceof UseItemOnEntity)) {
            return false;
        }
        UseItemOnEntity rhs = (UseItemOnEntity) var1;
