...
public class Debug {
  ...
  public static void logCharacterMessage(String message, Character character, boolean isPublic) {
    message = String.format("§1§l§o<%s>§r %s", new Object[] { character.shortName, message });
    logInternal(message);
  }
...
//    if (AltoClefController.getInstance() == null || AltoClefController.getInstance().getModSettings() == null)
//      return true;
    String enabledLogLevel = "ALL";//AltoClefController.getInstance().getModSettings().getLogLevel();
