...
public class TaskCatalogue {
    private static final HashMap<String, Item[]> nameToItemMatches = (HashMap) new HashMap<>();
    ...
    static {
        ...
        woodTasks("log", wood -> wood.log, (wood, count) -> new MineAndCollectTask(wood.log, count.intValue(), new Block[]{Block.getBlockFromItem(wood.log)}, MiningRequirement.HAND), true);
        mine("dirt", MiningRequirement.HAND, new Block[]{Blocks.DIRT, Blocks.GRASS_BLOCK, Blocks.DIRT_PATH}, new Item[]{Items.DIRT});
        simple("cobblestone", Items.COBBLESTONE, adris.altoclef.tasks.resources.CollectBlockByOneTask.CollectCobblestoneTask::new).dontMineIfPresent();
        simple("cobbled_deepslate", Items.COBBLED_DEEPSLATE, adris.altoclef.tasks.resources.CollectBlockByOneTask.CollectCobbledDeepslateTask::new).dontMineIfPresent();
        ...
        mine("coal", MiningRequirement.WOOD, new Block[]{Blocks.COAL_ORE, Blocks.DEEPSLATE_COAL_ORE}, new Item[]{Items.COAL});
        mine("raw_iron", MiningRequirement.STONE, new Block[]{Blocks.IRON_ORE, Blocks.DEEPSLATE_IRON_ORE}, new Item[]{Items.RAW_IRON});
        mine("raw_gold", MiningRequirement.IRON, new Block[]{Blocks.GOLD_ORE, Blocks.DEEPSLATE_GOLD_ORE}, new Item[]{Items.RAW_GOLD});
        mine("raw_copper", MiningRequirement.STONE, new Block[]{Blocks.COPPER_ORE, Blocks.DEEPSLATE_COPPER_ORE}, new Item[]{Items.RAW_COPPER});
        mine("diamond", MiningRequirement.IRON, new Block[]{Blocks.DIAMOND_ORE, Blocks.DEEPSLATE_DIAMOND_ORE}, new Item[]{Items.DIAMOND});
        mine("emerald", MiningRequirement.IRON, new Block[]{Blocks.EMERALD_ORE, Blocks.DEEPSLATE_EMERALD_ORE}, new Item[]{Items.EMERALD});
        mine("redstone", MiningRequirement.IRON, new Block[]{Blocks.REDSTONE_ORE, Blocks.DEEPSLATE_REDSTONE_ORE}, new Item[]{Items.REDSTONE});
        mine("lapis_lazuli", MiningRequirement.STONE, new Block[]{Blocks.LAPIS_ORE, Blocks.DEEPSLATE_LAPIS_ORE}, new Item[]{Items.LAPIS_LAZULI});
        ...
        simple("sapling", ItemHelper.SAPLINGS, adris.altoclef.tasks.resources.CollectSaplingsTask::new);
        simple("sandstone", Items.SANDSTONE, adris.altoclef.tasks.resources.CollectSandstoneTask::new).dontMineIfPresent();
        simple("red_sandstone", Items.RED_SANDSTONE, adris.altoclef.tasks.resources.CollectRedSandstoneTask::new).dontMineIfPresent();
        simple("coarse_dirt", Items.COARSE_DIRT, adris.altoclef.tasks.resources.CollectCoarseDirtTask::new).dontMineIfPresent();
        simple("amethyst_block", Items.AMETHYST_BLOCK, adris.altoclef.tasks.resources.CollectAmethystBlockTask::new).dontMineIfPresent();
        simple("dripstone_block", Items.DRIPSTONE_BLOCK, adris.altoclef.tasks.resources.CollectDripstoneBlockTask::new).dontMineIfPresent();
        simple("flint", Items.FLINT, adris.altoclef.tasks.resources.CollectFlintTask::new);
        simple("obsidian", Items.OBSIDIAN, adris.altoclef.tasks.resources.CollectObsidianTask::new).dontMineIfPresent();
        simple("wool", ItemHelper.WOOL, CollectWoolTask::new);
        simple("egg", Items.EGG, adris.altoclef.tasks.resources.CollectEggsTask::new);
        mob("bone", Items.BONE, SkeletonEntity.class);
        mob("gunpowder", Items.GUNPOWDER, CreeperEntity.class);
        simple("ender_pearl", Items.ENDER_PEARL, adris.altoclef.tasks.resources.KillEndermanTask::new);
        ...
        mine("brown_mushroom", MiningRequirement.HAND, new Block[]{Blocks.BROWN_MUSHROOM, Blocks.BROWN_MUSHROOM_BLOCK}, new Item[]{Items.BROWN_MUSHROOM});
        mine("red_mushroom", MiningRequirement.HAND, new Block[]{Blocks.RED_MUSHROOM, Blocks.RED_MUSHROOM_BLOCK}, new Item[]{Items.RED_MUSHROOM});
        mine("mushroom", MiningRequirement.HAND, new Block[]{Blocks.BROWN_MUSHROOM, Blocks.BROWN_MUSHROOM_BLOCK, Blocks.RED_MUSHROOM, Blocks.RED_MUSHROOM_BLOCK}, new Item[]{Items.BROWN_MUSHROOM, Items.RED_MUSHROOM});
        ...
        simple("blaze_rod", Items.BLAZE_ROD, adris.altoclef.tasks.resources.CollectBlazeRodsTask::new).forceDimension(Dimension.NETHER);
        mine("quartz", MiningRequirement.WOOD, Blocks.NETHER_QUARTZ_ORE, Items.QUARTZ).forceDimension(Dimension.NETHER);
        simple("cocoa_beans", Items.COCOA_BEANS, adris.altoclef.tasks.resources.CollectCocoaBeansTask::new);
        ...
        shear("lily_pad", Blocks.LILY_PAD, new Item[]{Items.LILY_PAD}).dontMineIfPresent();
        shear("tall_grass", Blocks.TALL_GRASS, new Item[]{Items.TALL_GRASS}).dontMineIfPresent();
        shear("fern", Blocks.FERN, new Item[]{Items.FERN}).dontMineIfPresent();
        shear("large_fern", Blocks.LARGE_FERN, new Item[]{Items.LARGE_FERN}).dontMineIfPresent();
        shear("dead_bush", Blocks.DEAD_BUSH, new Item[]{Items.DEAD_BUSH}).dontMineIfPresent();
        shear("glow_lichen", Blocks.GLOW_LICHEN, new Item[]{Items.GLOW_LICHEN}).dontMineIfPresent();
        simple("flower", ItemHelper.FLOWER, adris.altoclef.tasks.resources.CollectFlowerTask::new);
        ...
        simple("wheat", Items.WHEAT, adris.altoclef.tasks.resources.CollectWheatTask::new);
        ...
        simple("wheat_seeds", Items.WHEAT_SEEDS, adris.altoclef.tasks.resources.CollectWheatSeedsTask::new);
        crop("beetroot_seeds", Items.BEETROOT_SEEDS, Blocks.BEETROOTS, Items.BEETROOT_SEEDS);
        simple("netherite_upgrade_smithing_template", Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE, adris.altoclef.tasks.resources.GetSmithingTemplateTask::new);
        ...
        for (CataloguedResource woodCatalogue : woodTasks("planks", wood -> wood.planks, (wood, count) -> {
            CollectPlanksTask result = new CollectPlanksTask(wood.planks, count.intValue());
        ...
        for (CataloguedResource woodCatalogue : woodTasks("stripped_logs", wood -> wood.strippedLog, (wood, count) -> new CollectStrippedLogTask(wood.strippedLog, count.intValue())))
            woodCatalogue.dontMineIfPresent();
        simple("stick", Items.STICK, adris.altoclef.tasks.resources.CollectSticksTask::new);
        smelt("stone", Items.STONE, "cobblestone", new Item[0]).dontMineIfPresent();
        smelt("deepslate", Items.DEEPSLATE, "cobbled_deepslate", new Item[0]).dontMineIfPresent();
        smelt("smooth_stone", Items.SMOOTH_STONE, "stone", new Item[0]);
        smelt("smooth_quartz", Items.SMOOTH_QUARTZ, "quartz_block", new Item[0]);
        smelt("smooth_basalt", Items.SMOOTH_BASALT, "basalt", new Item[0]);
        smelt("glass", Items.GLASS, "sand", new Item[0]).dontMineIfPresent();
        simple("iron_ingot", Items.IRON_INGOT, adris.altoclef.tasks.resources.CollectIronIngotTask::new).forceDimension(Dimension.OVERWORLD);
        smelt("copper_ingot", Items.COPPER_INGOT, "raw_copper", new Item[]{Items.COPPER_ORE});
        smelt("charcoal", Items.CHARCOAL, "log", new Item[0]);
        smelt("brick", Items.BRICK, "clay_ball", new Item[0]);
        smelt("nether_brick", Items.NETHER_BRICK, "netherrack", new Item[0]);
        smelt("green_dye", Items.GREEN_DYE, "cactus", new Item[0]);
        simple("gold_ingot", Items.GOLD_INGOT, adris.altoclef.tasks.resources.CollectGoldIngotTask::new).anyDimension();
        ...
        smelt("netherite_scrap", Items.NETHERITE_SCRAP, "ancient_debris", new Item[0]);
        ...
        simple("gold_nugget", Items.GOLD_NUGGET, adris.altoclef.tasks.resources.CollectGoldNuggetsTask::new);
        ...
        simple("hay_block", Items.HAY_BLOCK, adris.altoclef.tasks.resources.CollectHayBlockTask::new).dontMineIfPresent();
        ...
        simple("nether_bricks", Items.NETHER_BRICKS, adris.altoclef.tasks.resources.CollectNetherBricksTask::new).dontMineIfPresent();
        shapedRecipe2x2Block("red_nether_bricks", Items.RED_NETHER_BRICKS, 4, "nether_wart");
        smelt("cracked_stone_bricks", Items.CRACKED_STONE_BRICKS, "stone_bricks", new Item[0]);
        smelt("cracked_nether_bricks", Items.CRACKED_NETHER_BRICKS, "nether_bricks", new Item[0]);
        smelt("cracked_polished_blackstone_bricks", Items.CRACKED_POLISHED_BLACKSTONE_BRICKS, "polished_blackstone_bricks", new Item[0]);
        smelt("cracked_deepslate_bricks", Items.CRACKED_DEEPSLATE_BRICKS, "deepslate_bricks", new Item[0]);
        smelt("cracked_deepslate_tiles", Items.CRACKED_DEEPSLATE_TILES, "deepslate_tiles", new Item[0]);
        smelt("smooth_sandstone", Items.SMOOTH_SANDSTONE, "sandstone", new Item[0]);
        smelt("smooth_red_sandstone", Items.SMOOTH_RED_SANDSTONE, "red_sandstone", new Item[0]);
        ...
        simple("magma_cream", Items.MAGMA_CREAM, adris.altoclef.tasks.resources.CollectMagmaCreamTask::new);
        ...
        simple("water_bucket", Items.WATER_BUCKET, adris.altoclef.tasks.resources.CollectBucketLiquidTask.CollectWaterBucketTask::new);
        simple("lava_bucket", Items.LAVA_BUCKET, adris.altoclef.tasks.resources.CollectBucketLiquidTask.CollectLavaBucketTask::new);
        String a = "paper";
        ...
        woodTasks("boat", woodItems -> woodItems.boat, (woodItems, count) -> new CollectBoatTask(woodItems.boat, woodItems.prefix + "_planks", count.intValue()));
        shapedRecipe3x3("lead", Items.LEAD, 1, "string", "string", o, "string", "slime_ball", o, o, o, "string");
        simple("honeycomb", Items.HONEYCOMB, adris.altoclef.tasks.resources.CollectHoneycombTask::new);
        String h = "honeycomb";
        ...
        woodTasks("pressure_plate", woodItems -> woodItems.pressurePlate, (woodItems, count) -> new CollectWoodenPressurePlateTask(woodItems.pressurePlate, woodItems.prefix + "_planks", count.intValue()));
        simple("wooden_button", ItemHelper.WOOD_BUTTON, adris.altoclef.tasks.resources.wood.CollectWoodenButtonTask::new);
        ...
        woodTasks("sign", woodItems -> woodItems.sign, (woodItems, count) -> new CollectSignTask(woodItems.sign, woodItems.prefix + "_planks", count.intValue()));
        ...
        woodTasks("hanging_sign", woodItems -> woodItems.hangingSign, (woodItems, count) -> new CollectHangingSignTask(woodItems.hangingSign, woodItems.prefix + "_stripped_logs", count.intValue()));
        ...
        colorfulTasks("bed", colors -> colors.bed, (colors, count) -> new CollectBedTask(colors.bed, colors.colorName + "_wool", count.intValue()));
        ...
        simple("carved_pumpkin", Items.CARVED_PUMPKIN, count -> new CarveThenCollectTask(Items.CARVED_PUMPKIN, count.intValue(), Blocks.CARVED_PUMPKIN, Items.PUMPKIN, Blocks.PUMPKIN, Items.SHEARS));
        ...
        woodTasks("stairs", woodItems -> woodItems.stairs, (woodItems, count) -> new CollectWoodenStairsTask(woodItems.stairs, woodItems.prefix + "_planks", count.intValue()));
        simple("wooden_slab", ItemHelper.WOOD_SLAB, CollectWoodenSlabTask::new);
        woodTasks("slab", woodItems -> woodItems.slab, (woodItems, count) -> new CollectWoodenSlabTask(woodItems.slab, woodItems.prefix + "_planks", count.intValue()));
        simple("wooden_door", ItemHelper.WOOD_DOOR, CollectWoodenDoorTask::new);
        woodTasks("door", woodItems -> woodItems.door, (woodItems, count) -> new CollectWoodenDoorTask(woodItems.door, woodItems.prefix + "_planks", count.intValue()));
        simple("wooden_trapdoor", ItemHelper.WOOD_TRAPDOOR, CollectWoodenTrapDoorTask::new);
        woodTasks("trapdoor", woodItems -> woodItems.trapdoor, (woodItems, count) -> new CollectWoodenTrapDoorTask(woodItems.trapdoor, woodItems.prefix + "_planks", count.intValue()));
        simple("wooden_fence", ItemHelper.WOOD_FENCE, CollectFenceTask::new);
        woodTasks("fence", woodItems -> woodItems.fence, (woodItems, count) -> new CollectFenceTask(woodItems.fence, woodItems.prefix + "_planks", count.intValue()));
        simple("wooden_fence_gate", ItemHelper.WOOD_FENCE_GATE, CollectFenceGateTask::new);
        woodTasks("fence_gate", woodItems -> woodItems.fenceGate, (woodItems, count) -> new CollectFenceGateTask(woodItems.fenceGate, woodItems.prefix + "_planks", count.intValue()));
        ...
        simple("milk", Items.MILK_BUCKET, adris.altoclef.tasks.resources.CollectMilkTask::new);
        mine("apple", Blocks.OAK_LEAVES, Items.APPLE);
        smelt("baked_potato", Items.BAKED_POTATO, "potato", new Item[0]);
    ...
    private static CataloguedResource put(String name, Item[] matches, Function<Integer, ResourceTask> getTask) {
        ...
        matches = supportedMatches.<Item>toArray(new Item[0]);
    ...
    public static ResourceTask getItemTask(String name, int count) {
        ...
        return ((CataloguedResource) nameToResourceTask.get(name)).getResource(count);
    }
    ...
    public static ResourceTask getItemTask(Item item, int count) {
        ...
        return ((CataloguedResource) itemToResourceTask.get(item)).getResource(count);
    }
    ...
    public static ResourceTask getItemTask(ItemTarget target) {
        ...
        return (ResourceTask) getSquashedItemTask(new ItemTarget[]{target});
    }
    ...
    private static CataloguedResource mine(String name, MiningRequirement requirement, Block[] toMine, Item... targets) {
        return put(name, targets, count -> new MineAndCollectTask(new ItemTarget(targets, count.intValue()), toMine, requirement)).dontMineIfPresent();
    }

    private static CataloguedResource mine(String name, MiningRequirement requirement, Block toMine, Item target) {
        return mine(name, requirement, new Block[]{toMine}, new Item[]{target});
    }
    ...
    private static CataloguedResource shear(String name, Block[] toShear, Item... targets) {
        return put(name, targets, count -> new ShearAndCollectBlockTask(new ItemTarget[]{new ItemTarget(targets, count.intValue())}, toShear)).dontMineIfPresent();
    }
    ...
    private static CataloguedResource shapedRecipe2x2(String name, Item match, int outputCount, String s0, String s1, String s2, String s3) {
        ...
        return put(name, new Item[]{match}, count -> new CraftInInventoryTask(new RecipeTarget(match, count.intValue(), recipe)));
    }
    ...
    private static CataloguedResource shapedRecipe3x3(String name, Item match, int outputCount, String s0, String s1, String s2, String s3, String s4, String s5, String s6, String s7, String s8) {
        ...
        return put(name, new Item[]{match}, count -> new CraftInTableTask(new RecipeTarget(match, count.intValue(), recipe)));
    }
    ...
    private static CataloguedResource smelt(String name, Item[] matches, String materials, Item... optionalMaterials) {
        return put(name, matches, count -> new SmeltInFurnaceTask(new SmeltTarget(new ItemTarget(matches, count.intValue()), new ItemTarget(materials, count.intValue()), optionalMaterials)));
    }
    ...
    private static CataloguedResource smith(String name, Item[] matches, String materials, String tool) {
        return put(name, matches, count -> new UpgradeInSmithingTableTask(new ItemTarget(tool, count.intValue()), new ItemTarget(materials, count.intValue()), new ItemTarget(matches, count.intValue())));
    }
    ...
    private static CataloguedResource mob(String name, Item[] matches, Class mobClass) {
        return put(name, matches, count -> new KillAndLootTask(mobClass, new ItemTarget[]{new ItemTarget(matches, count.intValue())}));
    }
    ...
    private static void mobCook(String uncookedName, String cookedName, Item uncooked, Item cooked, Class mobClass) {
        ...
        smelt(cookedName, cooked, uncookedName, new Item[0]);
    }
    ...
    private static CataloguedResource crop(String name, Item[] matches, Block[] cropBlocks, Item[] cropSeeds) {
        return put(name, matches, count -> new CollectCropTask(new ItemTarget(matches, count.intValue()), cropBlocks, cropSeeds));
    }
    ...
    private static void colorfulTasks(String baseName, Function<ItemHelper.ColorfulItems, Item> getMatch, BiFunction<ItemHelper.ColorfulItems, Integer, ResourceTask> getTask) {
        for (DyeColor dCol : DyeColor.values()) {
            ...
            put(prefix + "_" + prefix, new Item[]{getMatch.apply(color)}, count -> (ResourceTask) getTask.apply(color, count));
        }
    }
    ...
    private static CataloguedResource[] woodTasks(Function<ItemHelper.WoodItems, String> getCatalogueName, Function<ItemHelper.WoodItems, Item> getMatch, BiFunction<ItemHelper.WoodItems, Integer, ResourceTask> getTask, boolean requireNetherForNetherStuff) {
        ...
        for (WoodType woodType : WoodType.values()) {
            ...
            if (match != null) {
                ...
                CataloguedResource t = put(cataloguedName, new Item[]{match}, count -> (ResourceTask) getTask.apply(woodItems, count));
                if (requireNetherForNetherStuff && isNether)
                    t.forceDimension(Dimension.NETHER);
                result.add(t);
            }
        }
        return (CataloguedResource[]) result.toArray(x$0 -> new CataloguedResource[x$0]);
    }
