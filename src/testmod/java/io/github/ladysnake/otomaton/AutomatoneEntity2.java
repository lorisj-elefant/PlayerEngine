...
public class AutomatoneEntity2 extends LivingEntity implements IAutomatone, IInventoryProvider, IInteractionManagerProvider, IHungerManagerProvider {
    ...
    public AutomatoneEntity2(EntityType<? extends AutomatoneEntity2> type, World world) {
        super(type, world);
        init();
    ...
    public AutomatoneEntity2(World world, Character character){
